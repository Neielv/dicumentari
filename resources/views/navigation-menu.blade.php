        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    -->
                        <x-jet-nav-link href="{{ route('bodegas') }}" :active="request()->routeIs('bodegas')">
                            {{ __('Bodegas') }}
                        </x-jet-nav-link>
                        <x-jet-nav-link href="{{ route('usuarios') }}" :active="request()->routeIs('usuarios')">
                            {{ __('Usuarios') }}
                        </x-jet-nav-link>
                        <x-jet-nav-link href="{{ route('estanterias') }}" :active="request()->routeIs('estanterias')">
                            {{ __('Estanterias') }}
                        </x-jet-nav-link>
                        ...
                        <!--
                        <x-jet-nav-link href="{{ route('ingresos') }}" :active="request()->routeIs('ingresos')">
                            {{ __('Ingresos') }}
                        </x-jet-nav-link>
                        <x-jet-nav-link href="{{ route('traslados') }}" :active="request()->routeIs('traslados')">
                            {{ __('Traslados') }}
                        </x-jet-nav-link>   
                    -->                     
                    @endif
                    ...
                    <x-jet-nav-link href="{{ route('existencia') }}" :active="request()->routeIs('existencia')">
                        {{ __('Inventario') }}
                    </x-jet-nav-link>
